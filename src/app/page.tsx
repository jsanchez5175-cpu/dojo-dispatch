...
const FIGHTERS = [
  { id:'ryu',      name:'Ryu',       type:'All-rounder',  tier:'A', color:'#185FA5', stats:{power:82,speed:70,range:74,defense:78,combo:68,drive:75}, tags:['Shoto','Denjin','Anti-air'],       profile:'The eternal wanderer. EndingWalker\'s 10-0 SFL run proved Ryu elite in Season 3. Denjin Hadoken now hits 8 times after the June 2025 buff — strongest zoning game in SF6 history.', strengths:['Best anti-air','Denjin zoning','Long normals'], weaknesses:['Predictable','Limited mix-up','Specials mostly negative'] },
  { id:'luke',     name:'Luke',      type:'Rush-down',    tier:'S', color:'#E24B4A', stats:{power:90,speed:82,range:68,defense:72,combo:88,drive:85}, tags:['Rush-down','High damage','Sand blast'],profile:'Face of SF6. Punk won EVO 2024 with 10,240 entrants using Luke. Relentless Drive Rush pressure and elite damage output. Perpetual S-tier since launch.', strengths:['Exceptional damage','Safe pressure','Drive Rush combos'], weaknesses:['Predictable','Lower defense','Needs DP respect'] },
  { id:'juri',     name:'Juri',      type:'Footsies',     tier:'S', color:'#9933CC', stats:{power:76,speed:90,range:80,defense:68,combo:92,drive:88}, tags:['Charge store','Combo heavy','Fast normals'],profile:'Fuhajin charge stores create unique offensive pressure with lightning-fast footsies and massive combo potential. Highest combo ceiling in SF6.', strengths:['Incredible combos','Excellent range','Fast normals'], weaknesses:['Charge management','High execution','Weak reversals'] },
  { id:'ken',      name:'Ken',       type:'Aggressive',   tier:'S', color:'#CC4400', stats:{power:86,speed:85,range:70,defense:70,combo:85,drive:82}, tags:['Shoto','Rekkas','Corner carry'],    profile:'More aggressive than Ryu. Rekka strings and elite corner carry make every knockdown a potential round ender. Top 3 in the game.', strengths:['Corner carry','High/low mix','Rekka pressure'], weaknesses:['Shorter range','Requires reads','Less consistent neutral'] },
  { id:'cammy',    name:'Cammy',     type:'Speed',        tier:'A', color:'#2A6622', stats:{power:72,speed:95,range:65,defense:68,combo:80,drive:86}, tags:['Vortex','Strike/throw','Speed'],    profile:'Fastest movement in the game. Vortex pressure wins neutral through superior mobility and constant throw threat situation.', strengths:['Fastest movement','Vortex game','Safe options'], weaknesses:['Lower damage','Shorter limbs','Weak vs fireballs'] },
  { id:'zangief',  name:'Zangief',   type:'Grappler',     tier:'B', color:'#880000', stats:{power:98,speed:45,range:72,defense:92,combo:65,drive:70}, tags:['Grappler','SPD','Tank'],            profile:'The Red Cyclone. One successful SPD shifts entire momentum. Every step he takes is a calculated threat. High risk, devastating reward.', strengths:['Highest damage grabs','Incredible defense','Armor moves'], weaknesses:['Very slow','Loses to fireballs','Must get in'] },
  { id:'kimberly', name:'Kimberly',  type:'Mix-up',       tier:'A', color:'#CC6600', stats:{power:74,speed:92,range:62,defense:66,combo:86,drive:90}, tags:['Ninja','Spray','Mix-up'],          profile:'Ninja toolkit with teleports and spray cans. Layered mix-ups hard to read even with full knowledge. Highest Drive usage ceiling in the game.', strengths:['Diverse mix-ups','Excellent mobility','Spray setups'], weaknesses:['Needs resources','Average damage','Punishable on errors'] },
  { id:'chunli',   name:'Chun-Li',   type:'Footsies',     tier:'S', color:'#2244AA', stats:{power:78,speed:88,range:82,defense:74,combo:84,drive:87}, tags:['Poke heavy','Kikoken','Chip'],      profile:'The strongest woman in the world. Elite poke range and chip damage wins neutral from almost any range while building meter constantly.', strengths:['Best poke range','Great chip damage','Strong meter gain'], weaknesses:['Modest mix-up','Execution demand','Struggles vs large bodies'] },
  { id:'alex',     name:'Alex',      type:'Grapple/Rush', tier:'B', color:'#3A7A3A', isNew:true, stats:{power:88,speed:68,range:70,defense:82,combo:74,drive:76}, tags:['New','Power Bomb','SF3'],  profile:'Year 3 DLC. Grappler/rush hybrid from SF3 with Power Bomb and Slash Elbow. Currently B-tier with high upside potential that nobody has fully solved yet.', strengths:['Corner damage','Armor on EX','Diverse toolkit'], weaknesses:['Limited neutral','Slow to get in','Still being solved'] },
  { id:'guile',    name:'Guile',     type:'Keepaway',     tier:'A', color:'#336699', stats:{power:74,speed:65,range:84,defense:76,combo:72,drive:78}, tags:['Sonic Boom','Charge','Zoner'],      profile:'US Air Force. Sonic Boom wall and Flash Kick anti-air define his neutral. NuckleDu\'s signature character and the textbook definition of defensive SF.', strengths:['Fireball zoning','Flash Kick anti-air','Defensive play'], weaknesses:['Charge mechanic','Slow movement','Requires patience'] },
  { id:'dhalsim',  name:'Dhalsim',   type:'Zoner',        tier:'C', color:'#CC6600', stats:{power:68,speed:55,range:98,defense:60,combo:65,drive:72}, tags:['Yoga fire','Teleport','Range'],     profile:'Longest limbs in the game. Teleport mix and yoga fire create impossible spacing situations that are uniquely difficult to deal with.', strengths:['Longest range','Teleport mix','Unique spacing'], weaknesses:['Fragile','Needs patience','High execution'] },
  { id:'blanka',   name:'Blanka',    type:'Gimmick',      tier:'B', color:'#2A7A2A', stats:{power:80,speed:72,range:68,defense:74,combo:70,drive:74}, tags:['Electric','Blanka-chan','Wild'],    profile:'Wild child from Brazil. Blanka-chan dolls and electric attacks create unique mind games at all skill levels.', strengths:['Blanka-chan pressure','Electric defense','Surprise factor'], weaknesses:['Predictable normals','Limited neutral tools','Requires reads'] },
  { id:'ehonda',   name:'E. Honda',  type:'Grappler',     tier:'B', color:'#CC4444', stats:{power:90,speed:55,range:65,defense:85,combo:68,drive:68}, tags:['Headbutt','Sumo','Armor'],         profile:'Sumo wrestler with armored headbutts that eat fireballs. Tanky, consistent, and one of the most annoying characters to face at lower levels.', strengths:['Armored headbutt','Tanky defense','Consistent damage'], weaknesses:['Limited range','Predictable','Struggles vs top tier'] },
  { id:'deejay',   name:'Dee Jay',   type:'All-rounder',  tier:'C', color:'#CC9900', stats:{power:76,speed:78,range:72,defense:70,combo:78,drive:80}, tags:['Sobat','Dreadnought','Music'],     profile:'Jamaican kickboxer with one of the best Drive Rush neutral games. Underrated due to execution requirements.', strengths:['Strong Drive Rush','Good footsies','Underestimated'], weaknesses:['High execution','Below avg damage','Complex gameplan'] },
  { id:'manon',    name:'Manon',     type:'Grappler',     tier:'B', color:'#AA44AA', stats:{power:82,speed:68,range:76,defense:72,combo:76,drive:74}, tags:['Medal','Judo','Elegant'],          profile:'French judo champion with medal stacking mechanic. Gets dramatically scarier with every successful throw. Unique risk/reward character.', strengths:['Medal scaling','Elegant footsies','Unique mechanic'], weaknesses:['Needs medals','Average neutral','Mediocre without resources'] },
  { id:'marisa',   name:'Marisa',    type:'Heavy',        tier:'B', color:'#886633', stats:{power:95,speed:50,range:74,defense:88,combo:72,drive:72}, tags:['Gladiator','Armor','Power'],       profile:'Italian gladiator with massive damage and armored moves. One of the highest damage floors in SF6 — every hit hurts.', strengths:['Huge damage','Armored attacks','Corner presence'], weaknesses:['Very slow','Limited mix-up','Easy to zone'] },
  { id:'jp',       name:'JP',        type:'Zoner',        tier:'C', color:'#553388', stats:{power:74,speed:60,range:90,defense:68,combo:80,drive:86}, tags:['Psycho Power','Zoner','Europe'],   profile:'April 2026 bug fix reduced his unintended frame advantage. Tokido plays him in Season 3 and believes the character is still dominant at highest level.', strengths:['Fullscreen control','Drive Rush options','Unique tools'], weaknesses:['April patch hurt him','Niche game plan','Requires mastery'] },
  { id:'lily',     name:'Lily',      type:'Rush',         tier:'C', color:'#CC5533', stats:{power:76,speed:82,range:64,defense:66,combo:74,drive:82}, tags:['Wind','Tomahawk','Stocks'],        profile:'Wind stock mechanic fuels aggressive rush-down that snowballs heavily with resources. Resource-dependent but explosive.', strengths:['Wind stock pressure','Aggressive neutral','Good Drive Rush'], weaknesses:['Resource dependent','Limited without stocks','Below avg damage'] },
  { id:'jamie',    name:'Jamie',     type:'Rush',         tier:'C', color:'#3355AA', stats:{power:78,speed:80,range:66,defense:68,combo:82,drive:84}, tags:['Drink','Breakdance','Levels'],     profile:'Hong Kong breakdancer who gets dramatically stronger with each drink level. Completely different character at level 4 vs level 0.', strengths:['Level 4 power spike','Unique scaling','Surprising damage'], weaknesses:['Weak at level 0','Risky gameplan','Needs time to ramp'] },
  { id:'rashid',   name:'Rashid',    type:'Speed',        tier:'A', color:'#3388CC', stats:{power:72,speed:92,range:70,defense:66,combo:82,drive:88}, tags:['Wind','Speed','EVO 2023'],         profile:'AngryBird won EVO 2023 with Rashid — the first ever SF6 EVO championship. Incredible speed and Drive Rush options.', strengths:['Elite speed','Strong Drive Rush','Versatile toolkit'], weaknesses:['Lower damage','Requires execution','Neutral limiting'] },
  { id:'aki',      name:'AKI',       type:'Zoner',        tier:'C', color:'#AA3388', stats:{power:72,speed:78,range:76,defense:64,combo:80,drive:82}, tags:['Poison','Snake','Assassin'],       profile:'Poison-based assassin with unique venom mechanic. Creates tick damage and difficult mix-up situations with stacked poison.', strengths:['Poison pressure','Unique mechanic','Mix-up potential'], weaknesses:['Low health','Requires setup','Execution heavy'] },
  { id:'ed',       name:'Ed',        type:'Rush-down',    tier:'A', color:'#4455CC', stats:{power:82,speed:84,range:68,defense:72,combo:84,drive:86}, tags:['Psycho Power','Boxing','Simple'],   profile:'Young Psycho Power user with streamlined controls. One of the easiest characters to pick up with high damage reward ceiling.', strengths:['Simple execution','Strong pressure','Good damage'], weaknesses:['Somewhat linear','Predictable gameplan','Limited defensive options'] },
  { id:'akuma',    name:'Akuma',     type:'Aggressive',   tier:'S', color:'#660022', stats:{power:92,speed:86,range:76,defense:64,combo:90,drive:90}, tags:['Satsui no Hado','Demon','SA3'],    profile:'Lowest health in the game but highest damage ceiling. Demon Armageddon SA3 ends rounds instantly. Mastery required.', strengths:['Elite damage','Demon Armageddon SA3','Gohadoken pressure'], weaknesses:['Lowest health','High risk','Requires mastery'] },
  { id:'terry',    name:'Terry',     type:'All-rounder',  tier:'A', color:'#CC3300', stats:{power:84,speed:78,range:72,defense:74,combo:82,drive:82}, tags:['SNK','Power Wave','Fatal Fury'],   profile:'Fatal Fury legend as SF6 DLC. Power Wave and Buster Wolf bring SNK flavor to the SF6 meta with strong neutral tools.', strengths:['Strong neutral','Good damage','Power Wave pressure'], weaknesses:['Takes time to master','Some linear strings','SNK adjustment'] },
  { id:'mai',      name:'Mai',       type:'Rush-down',    tier:'A', color:'#CC2244', stats:{power:76,speed:88,range:72,defense:66,combo:84,drive:86}, tags:['SNK','Fan','Kunoichi'],            profile:'SNK kunoichi as SF6 DLC. Fan projectiles and aerial mobility create unique pressure angles difficult to defend.', strengths:['Fan pressure','Air mobility','Mix-up angles'], weaknesses:['Needs practice','Resource dependent','Different from SF chars'] },
  { id:'mbison',   name:'M. Bison',  type:'Rush-down',    tier:'B', color:'#330088', stats:{power:86,speed:76,range:70,defense:74,combo:82,drive:80}, tags:['Psycho Power','Dictator','Return'], profile:'The dictator returns. April 2026 patch fixed the Psycho Mine Drive Reversal bug. Classic Bison pressure with modern tools.', strengths:['Strong pressure','Psycho Power tools','Classic fundamentals'], weaknesses:['Bug nerfed April patch','Corner dependent','Needs reads'] },
  { id:'sagat',    name:'Sagat',     type:'Zoner',        tier:'B', color:'#8B5E3C', stats:{power:88,speed:58,range:86,defense:80,combo:70,drive:74}, tags:['Tiger Shot','Muay Thai','Emperor'], profile:'The Muay Thai Emperor. Tiger Shot walls and Tiger Uppercut anti-air define his game. A fundamentals monster.', strengths:['Tiger Shot zoning','Elite anti-air','High damage'], weaknesses:['Slow movement','Charge mechanic','Predictable gameplan'] },
]
      ...
      {fighter && (
        <div style={{ background:'var(--sf-dark2)', border:'1px solid var(--sf-border)', borderRadius:4, overflow:'hidden', marginBottom:12 }}>
          ...
          <div style={{ padding:'12px 14px' }}>
            <p style={{ fontSize:12, color:'#aaaacc', lineHeight:1.65, marginBottom:12 }}>{fighter.profile}</p>
...
function SenseiTab() {
  ...
  const send = async (text?: string) => {
    ...
    try {
      ...
      setMsgs(prev=>[...prev, { role:'assistant', content:'Add your ANTHROPIC_API_KEY to .env.local to activate live Sensei.' }])
    }
    setLoading(false)
  }
...
function PlayersTab() {
  const [sel, setSel] = useState<string|null>(null)
  const players = [
    { key:'endingwalker', name:'EndingWalker',  flag:'🇩🇪', team:'MOUZ',      main:'Ryu',      badge:'🔥 Season 3 — 10-0 SFL',      bc:'var(--sf-green)',  bigStat:'10-0', bigLabel:'SFL record',   era:'Current', bio:"The most in-form player in SF6. His 10-0 SFL run with Ryu proves the character is elite in Season 3. Patient, methodical play maximises every Elena update buff.", stats:{neutralIQ:92,execution:88,adaptation:90,drive:85,clutch:87}, tags:['Patient neutral','Denjin charge','Anti-air discipline','Punish-first'], results:[{ev:'SFL Season 3',char:'Ryu',place:'10-0',prize:'Top seed'},{ev:'CC12',char:'Ryu',place:'Top 8',prize:'Qualified'}] },
    { key:'punk',         name:'Punk',          flag:'🇺🇸', team:'FLY',       main:'Luke',     badge:'EVO 2024 Champion',           bc:'var(--sf-gold)',   bigStat:'EVO',  bigLabel:'2024 Champ',   era:'Current', bio:"Benchmark of SF6 dominance. EVO 2024 win against 10,240 entrants cemented his legacy. Relentless Drive Rush pressure and pattern recognition that borders on predictive.", stats:{neutralIQ:94,execution:96,reads:92,drive:95,clutch:91}, tags:['Drive Rush master','Corner trap','Sand blast','High-dmg reads'], results:[{ev:'EVO 2024',char:'Luke',place:'1st',prize:'Champion'},{ev:'CC12',char:'Luke',place:'Top 16',prize:'Qualified'}] },
    { key:'tokido',       name:'Tokido',        flag:'🇯🇵', team:'REJECT',    main:'JP (S3)',  badge:'30+ EVO Top-8s · Legend',     bc:'var(--sf-purple)', bigStat:'30+',  bigLabel:'EVO Top-8s',   era:'Legend',  bio:"One of the Five Japanese Gods. 30+ EVO Top-8s across multiple franchises. Switched to JP for Season 3 — believes the April fix left the character fundamentally dominant.", stats:{reads:97,adaptation:95,neutralIQ:96,mental:98,clutch:94}, tags:['Patient zoning','Punish-first','Round adaptation','Gauge management'], results:[{ev:'CPT Japan',char:'JP',place:'1st',prize:'Premier win'},{ev:'CC12',char:'JP',place:'Top 16',prize:'Qualified'}] },
    { key:'menard',       name:'MenaRD',        flag:'🇩🇴', team:'',          main:'TBC',      badge:'EVO 2025 Champion',           bc:'var(--sf-gold)',   bigStat:'EVO',  bigLabel:'2025 Champ',   era:'Current', bio:"Reigning EVO champion. Already qualified for EWC 2026 via the SFL World Championship. One of the first confirmed names in Riyadh's $1M field.", stats:{aggression:95,execution:93,adaptation:88,clutch:94,drive:90}, tags:['Explosive offense','High-dmg combos','Mental resilience','GF performer'], results:[{ev:'EVO 2025',char:'TBC',place:'1st',prize:'Champion'},{ev:'EWC 2026',char:'TBC',place:'Qualified',prize:'$1M pool'}] },
    { key:'daigo',        name:'Daigo Umehara', flag:'🇯🇵', team:'ROHTO/Zst.',main:'Ryu/Ken',  badge:'The Beast · Living Legend',   bc:'var(--sf-red)',    bigStat:'EWC',  bigLabel:'2026 Qualified',era:'Legend',  bio:"The most famous player in fighting game history. First EVO champion. Multiple SF titles across decades. Qualified for EWC 2026 at age 42. Longevity is the ultimate flex.", stats:{neutralIQ:98,reads:97,adaptation:94,legacy:100,clutch:96}, tags:['Fundamentals','Parry god','Ryu specialist','Iron will'], results:[{ev:'SFL WC',char:'Ken',place:'Qualified',prize:'EWC 2026'},{ev:'EVO 2004',char:'Ryu',place:'The Parry',prize:'FGC Forever'}] },
    { key:'justinwong',   name:'Justin Wong',   flag:'🇺🇸', team:'EG Alumni', main:'Various',  badge:'8x EVO Champion · NYC Legend',bc:'#0066cc',          bigStat:'8x',   bigLabel:'EVO Champ',    era:'Legend',  bio:"One of the greatest American players in FGC history. 8 EVO championships across multiple franchises. Still competing at SF6 Season 3 majors after 30+ years.", stats:{neutralIQ:96,reads:98,adaptation:97,mentorship:100,clutch:95}, tags:['All-rounder','Mind games','Tournament veteran','Community builder'], results:[{ev:'Multiple EVOs',char:'Various',place:'8x Champion',prize:'FGC Icon'},{ev:'SF6 Majors S3',char:'Various',place:'Still competing',prize:'Legacy'}] },
    { key:'angrybird',    name:'AngryBird',     flag:'🇦🇪', team:'',          main:'Rashid',   badge:'EVO 2023 Champion',           bc:'var(--sf-green)',  bigStat:'EVO',  bigLabel:'2023 Champ',   era:'Current', bio:"The first ever SF6 EVO champion. Put the Middle Eastern FGC on the world stage at EVO 2023 with dominant Rashid play. A historic moment for regional representation.", stats:{neutralIQ:90,execution:92,reads:88,adaptation:86,clutch:93}, tags:['Rashid expert','Wind pressure','First SF6 EVO champ','Regional pride'], results:[{ev:'EVO 2023',char:'Rashid',place:'1st',prize:'First SF6 EVO Champ'},{ev:'CPT Circuit',char:'Rashid',place:'Top 8s',prize:'Multiple'}] },
    { key:'nuckledu',     name:'NuckleDu',      flag:'🇺🇸', team:'',          main:'Guile',    badge:'EVO 2016 Champion',           bc:'#4a7a4a',          bigStat:'EVO',  bigLabel:'2016 Champ',   era:'Legend',  bio:"EVO 2016 champion. His SF6 Guile play is textbook defensive excellence — Sonic Boom walls, Flash Kick reactions, walk-back punish game that defines the character.", stats:{neutralIQ:94,defense:97,reads:93,adaptation:88,clutch:90}, tags:['Guile specialist','Defensive master','Walk-back punish','Consistent placer'], results:[{ev:'EVO 2016',char:'Nash',place:'1st',prize:'EVO Champion'},{ev:'SF6 CPT',char:'Guile',place:'Multiple Top 8s',prize:'Consistent'}] },
  ]
